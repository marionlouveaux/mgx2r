...
knitr::include_graphics("https://github.com/statnmap/marionlouveaux/blob/master/img/mgx2r-logo.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("https://github.com/marionlouveaux/mgx2r/blob/master/inst/img/full/p1labels.png")
```
