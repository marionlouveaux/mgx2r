...
```{r}
ply.dir <- "/Users/mlouveaux/Documents/Postdoc/Projects/MGX-R bridge/MorphoGraphX2R/inst/extdata/normalMesh"
mesh.all <- map(list.files(ply.dir, recursive = TRUE, full.names = TRUE),
                ~ modified_read.ply(file = .x, ShowSpecimen = FALSE))


graph.dir <- "/Users/mlouveaux/Documents/Postdoc/Projects/MGX-R bridge/MorphoGraphX2R/inst/extdata/cellGraph"
...
# display.all <- list('heatmap', 'heatmap', 'heatmap', 'heatmap', 'heatmap') #check why with 'none' on the two firsts and 'labels' on the others, I display 'none' for n°1 and 3
# defaultColor = list("#CCCCFF", 0.2)
#display = 'none', 'heatmap', 'label' or 'cellaxis'
